...
class Terminal extends React.Component {
  ...
  constructor() {
    ...
    this.file = <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="feather feather-file-text"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path><polyline points="14 2 14 8 20 8"></polyline><line x1="16" y1="13" x2="8" y2="13"></line><line x1="16" y1="17" x2="8" y2="17"></line><polyline points="10 9 9 9 8 9"></polyline></svg>
    ...
    return (
      <div className="terminal">
        ...
        <div className="terminal-body">
          ...
          <p>{this.chev} <span>trev.edu.schools</span></p>
          <p className="inset">{this.chevs} university of michigan</p>
          <p className="inset">{this.chevs} hong kong university of science and technology</p>
          <p className="inset pad">{this.chevs} instituto mediterráneo sol granada</p>
          ...
          <p>{this.chev} <span>trev.résumé</span></p>
          <p className="inset pad">{this.chevs} 
            <a href="trever-cullen-resume.pdf" target="_blank">{this.file} trever-cullen-resume.pdf</a>
          </p>
